...
export default function WhatsAppFloat() {
  ...
  useEffect(() => {
    // Intentar leer de localStorage primero para evitar query extra
    try {
      const cached = localStorage.getItem("wa_url_cache");
    ...
    supabase
      ...
      .then(({ data }) => {
        ...
        if (fc?.whatsapp_url) {
          setUrl(fc.whatsapp_url);
          try { localStorage.setItem("wa_url_cache", fc.whatsapp_url); } catch {}
        }
      });
  }, []);
