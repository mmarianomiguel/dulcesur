          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">
                {visibles.length === 0
                  ? "Sin actualizaciones en los últimos 5 días"
                  : `${visibles.length} producto${visibles.length !== 1 ? "s" : ""} con precio actualizado en los últimos 5 días`}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {visibles.length === 0 ? (
          <div className="text-center py-20 text-gray-400">
            ...
            <p className="text-sm mt-1">Los precios se mantienen estables en los últimos 5 días.</p>
            <Link
              href="/productos"
