              ...
              return (
                <button
                  ...
                  className={
                    ...
                    (isActive
                      ? "bg-primary/5 font-medium text-primary/90"
              ...
              return (
                ...
                >
                  ...
                  {p.slug === "envios" ? (
                    ...
                    <div
                      className="prose prose-gray max-w-none prose-headings:text-gray-900 prose-h2:text-xl prose-h2:mt-6 prose-h2:mb-4 prose-h3:text-lg prose-p:text-gray-600 prose-p:leading-relaxed prose-li:text-gray-600 prose-strong:text-gray-900 prose-a:text-primary"
