...
type Section = "metodos" | "cuentas";

const NAV_ITEMS: { key: Section; label: string; icon: React.ReactNode }[] = [
  { key: "metodos", label: "Métodos de Pago", icon: <CreditCard className="w-4 h-4" /> },
  { key: "cuentas", label: "Cuentas Bancarias", icon: <Landmark className="w-4 h-4" /> },
];
...
export default function PagosConfigPage() {
  ...
  const [activeSection, setActiveSection] = useState<Section>("metodos");
